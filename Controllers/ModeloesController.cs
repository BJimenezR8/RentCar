...
namespace RentCar.Controllers
{
    public class ModeloesController : Controller
    {
        ...
        public ModeloesController(DbAa5e9fBryantj001Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdModelo,IdMarca,Nombre,Estado")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdModelo,IdMarca,Nombre,Estado")] Modelo modelo)
        {
